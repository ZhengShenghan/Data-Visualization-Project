...
!function (t, n) {
    ...
    var wt = 1, Mt = 2, Tt = 3, At = 4, St = 1e-6;
    ...
    function zt(t, n) {
        var e = [], r = null, i = null, o = 6, a = 6, u = 3,
            c = "undefined" != typeof window && window.devicePixelRatio > 1 ? 0 : .5, f = t === wt || t === At ? -1 : 1,
            s = t === At || t === Mt ? "x" : "y", l = t === wt || t === Tt ? Et : Nt;
        ...
        function h(h) {
            var d = null == r ? n.ticks ? n.ticks.apply(n, e) : n.domain() : r,
                ...
                v = +y[0] + c, _ = +y[y.length - 1] + c, b = (n.bandwidth ? Ct : kt)(n.copy(), c),
    ...
    Rt.prototype = Dt.prototype = {
        constructor: Rt, on: function (t, n) {
            ...
            if (!(arguments.length < 2)) {
                ...
                for (; ++a < u;) if (e = (t = o[a]).type) i[e] = qt(i[e], t.name, n); else if (null == n) for (e in i) i[e] = qt(i[e], t.name, null);
                return this
            }
            for (; ++a < u;) if ((e = (t = o[a]).type) && (e = Ft(i[e], t.name))) return e
        }, copy: function () {
            var t = {}, n = this._;
    ...
    var Ut = "http://www.w3.org/1999/xhtml", It = {
    ...
    en.prototype = {
        constructor: en, appendChild: function (t) {
    ...
    Wn.prototype = Zn.prototype = {
        constructor: Wn, select: function (t) {
            ...
            var e = n ? on : rn, r = this._parents, i = this._groups;
            ...
            for (var o = i.length, a = new Array(o), u = new Array(o), c = new Array(o), f = 0; f < o; ++f) {
                var s = r[f], l = i[f], h = l.length, d = un(t.call(s, s && s.__data__, f, r)), p = d.length,
            ...
            var e = Mn(t + "");
            if (arguments.length < 2) {
                for (var r = Tn(this.node()), i = -1, o = e.length; ++i < o;) if (!r.contains(e[i])) return !1;
                return !0
            }
            ...
            var e = "function" == typeof t ? t : Lt(t), r = null == n ? In : "function" == typeof n ? n : Ht(n);
            return this.select((function () {
    ...
    const re = {passive: !1}, ie = {capture: !0, passive: !1};
    ...
    function ue(t) {
        var n = t.document.documentElement, e = Kn(t).on("dragstart.drag", ae, ie);
        "onselectstart" in n ? e.on("selectstart.drag", ae, ie) : (n.__noselect = n.style.MozUserSelect, n.style.MozUserSelect = "none")
    }

    function ce(t, n) {
        var e = t.document.documentElement, r = Kn(t).on("dragstart.drag", null);
    ...
    var _e = .7, be = 1 / _e, me = "\\s*([+-]?\\d+)\\s*", xe = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*",
        we = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", Me = /^#([0-9a-f]{3,8})$/,
        Te = new RegExp(`^rgb\\(${me},${me},${me}\\)$`), Ae = new RegExp(`^rgb\\(${we},${we},${we}\\)$`),
        Se = new RegExp(`^rgba\\(${me},${me},${me},${xe}\\)$`), Ee = new RegExp(`^rgba\\(${we},${we},${we},${xe}\\)$`),
        Ne = new RegExp(`^hsl\\(${xe},${we},${we}\\)$`), ke = new RegExp(`^hsla\\(${xe},${we},${we},${xe}\\)$`), Ce = {
            aliceblue: 15792383,
    ...
    ge(ve, $e, {
        ...
        }, hex: Pe, formatHex: Pe, formatHex8: function () {
            return this.rgb().formatHex8()
        }, formatHsl: function () {
            return He(this).formatHsl()
        }, formatRgb: ze, toString: ze
    }), ge(Ue, qe, ye(ve, {
        brighter(t) {
    ...
    const Ke = Math.PI / 180, Qe = 180 / Math.PI, Je = .96422, tr = 1, nr = .82521, er = 4 / 29, rr = 6 / 29,
        ir = 3 * rr * rr, or = rr * rr * rr;
    ...
    var vr = -.14861, _r = 1.78277, br = -.29227, mr = -.90649, xr = 1.97294, wr = xr * mr, Mr = xr * _r,
        Tr = _r * br - mr * vr;
    ...
    function Ar(t, n, e, r) {
        return 1 === arguments.length ? function (t) {
            ...
            t instanceof Ue || (t = Fe(t));
            var n = t.r / 255, e = t.g / 255, r = t.b / 255, i = (Tr * r + wr * n - Mr * e) / (Tr + wr - Mr), o = r - i,
                a = (xr * (e - i) - br * o) / mr, u = Math.sqrt(a * a + o * o) / (xr * i * (1 - i)),
    ...
    ge(Sr, Ar, ye(ve, {
        brighter(t) {
            ...
            var t = isNaN(this.h) ? 0 : (this.h + 120) * Ke, n = +this.l, e = isNaN(this.s) ? 0 : this.s * n * (1 - n),
    ...
    var Rr = function t(n) {
        ...
        function r(t, n) {
            var r = e((t = qe(t)).r, (n = qe(n)).r), i = e(t.g, n.g), o = e(t.b, n.b), a = Dr(t.opacity, n.opacity);
            return function (n) {
    ...
    var Hr = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, Xr = new RegExp(Hr.source, "g");

    function Gr(t, n) {
        var e, r, i, o = Hr.lastIndex = Xr.lastIndex = 0, a = -1, u = [], c = [];
        for (t += "", n += ""; (e = Hr.exec(t)) && (r = Xr.exec(n));) (i = r.index) > o && (i = n.slice(o, i), u[a] ? u[a] += i : u[++a] = i), (e = e[0]) === (r = r[0]) ? u[a] ? u[a] += r : u[++a] = r : (u[++a] = null, c.push({
            i: a,
            x: Lr(e, r)
        })), o = Xr.lastIndex;
    ...
    var Zr, Kr = 180 / Math.PI, Qr = {translateX: 0, translateY: 0, rotate: 0, skewX: 0, scaleX: 1, scaleY: 1};
        ...
        function i(t, i) {
            ...
            if (g < 1e-12) a = Math.log(h / f) / n, o = function (t) {
                ...
                a = (m - b) / n, o = function (t) {
                    var r = t * a, i = ri(b), o = f / (e * y) * (i * function (t) {
    ...
    function oi(t) {
        return function (n, e) {
            var r = t((n = Xe(n)).h, (e = Xe(e)).h), i = Dr(n.s, e.s), o = Dr(n.l, e.l), a = Dr(n.opacity, e.opacity);
            return function (t) {
    ...
    var ai = oi(zr), ui = oi(Dr);

    function ci(t) {
        return function (n, e) {
            var r = t((n = pr(n)).h, (e = pr(e)).h), i = Dr(n.c, e.c), o = Dr(n.l, e.l), a = Dr(n.opacity, e.opacity);
            return function (t) {
    ...
    var fi = ci(zr), si = ci(Dr);

    function li(t) {
        return function n(e) {
            function r(n, r) {
                var i = t((n = Ar(n)).h, (r = Ar(r)).h), o = Dr(n.s, r.s), a = Dr(n.l, r.l),
    ...
    var gi, yi, vi = 0, _i = 0, bi = 0, mi = 1e3, xi = 0, wi = 0, Mi = 0,
    ...
    Ni.prototype = ki.prototype = {
        constructor: Ni, restart: function (t, n, e) {
    ...
    var Ri = Dt("start", "end", "cancel", "interrupt"), Fi = [], qi = 0, Ui = 1, Ii = 2, Oi = 3, Bi = 4, Yi = 5, Li = 6;
    ...
    go.prototype = yo.prototype = {
        ...
        select: function (t) {
            ...
            "function" != typeof t && (t = Ht(t));
            for (var r = this._groups, i = r.length, o = new Array(i), a = 0; a < i; ++a) for (var u, c, f = r[a], s = f.length, l = o[a] = new Array(s), h = 0; h < s; ++h) (u = f[h]) && (c = t.call(u, u.__data__, h, f)) && ("__data__" in u && (c.__data__ = u.__data__), l[h] = c, ji(l[h], n, e, h, l, Gi(u, e)));
        ...
        transition: function () {
            for (var t = this._name, n = this._id, e = vo(), r = this._groups, i = r.length, o = 0; o < i; ++o) for (var a, u = r[o], c = u.length, f = 0; f < c; ++f) if (a = u[f]) {
                var s = Gi(a, n);
                ji(a, t, e, f, u, {time: s.time + s.delay + s.duration, delay: 0, duration: s.duration, ease: s.ease})
            }
        ...
        attr: function (t, n) {
            var e = Ot(t), r = "transform" === e ? ei : Qi;
        ...
        style: function (t, n, e) {
            ...
            return null == n ? this.styleTween(t, function (t, n) {
                ...
                return function () {
                    var c = Xi(this, t), f = c.on, s = null == c.value[a] ? o || (o = ho(n)) : void 0;
        ...
        tween: function (t, n) {
            ...
            if (t += "", arguments.length < 2) {
                for (var r, i = Gi(this.node(), e).tween, o = 0, a = i.length; o < a; ++o) if ((r = i[o]).name === t) return r.value;
                return null
            }
    ...
    var Co = 4 / 11, Po = 6 / 11, zo = 8 / 11, $o = 3 / 4, Do = 9 / 11, Ro = 10 / 11, Fo = 15 / 16, qo = 21 / 22,
        Uo = 63 / 64, Io = 1 / Co / Co;
    ...
    var Bo = 1.70158, Yo = function t(n) {
        function e(t) {
        ...
        return n = +n, e.overshoot = t, e
    }(Bo), Ho = 2 * Math.PI, Xo = function t(n, e) {
    ...
    }(1, .3), Wo = {time: null, delay: 0, duration: 250, ease: mo};
    ...
    Zn.prototype.interrupt = function (t) {
        ...
        for (var r = this._groups, i = r.length, o = 0; o < i; ++o) for (var a, u = r[o], c = u.length, f = 0; f < c; ++f) (a = u[f]) && ji(a, t, n, f, u, e || Zo(a, n));
    ...
    var na = {name: "drag"}, ea = {name: "space"}, ra = {name: "handle"}, ia = {name: "center"};
    ...
    var sa = {
            name: "x", handles: ["w", "e"].map(_a), input: function (t, n) {
                return null == t ? null : [[+t[0], n[0][1]], [+t[1], n[1][1]]]
            }, output: function (t) {
                return t && [t[0][0], t[1][0]]
            }
        }, la = {
            name: "y", handles: ["n", "s"].map(_a), input: function (t, n) {
                return null == t ? null : [[n[0][0], +t[0]], [n[1][0], +t[1]]]
            }, output: function (t) {
                return t && [t[0][1], t[1][1]]
            }
        }, ha = {
            name: "xy", handles: ["n", "w", "e", "s", "nw", "ne", "sw", "se"].map(_a), input: function (t) {
        ...
        ya = {overlay: 1, selection: 1, n: null, e: 1, s: null, w: -1, nw: -1, ne: 1, se: 1, sw: -1},
        va = {overlay: 1, selection: 1, n: -1, e: null, s: 1, w: null, nw: -1, ne: -1, se: 1, sw: 1};
    ...
    function Ma(t) {
        ...
        function f() {
            var t = Kn(this), n = wa(this).selection;
        ...
        function h(e) {
            if ((!n || e.touches) && r.apply(this, arguments)) {
                var i, a, u, c, l, h, d, p, g, y, v, _ = this, b = e.target.__data__.type,
                    ...
                    x = t === la ? null : ya[b], w = t === sa ? null : va[b], M = wa(_), T = M.extent, A = M.selection,
                ...
                if ("overlay" === b) {
                    A && (g = !0);
                    const n = [$[0], $[1] || $[0]];
                    M.selection = A = [[i = t === la ? S : ua(n[0][0], n[1][0]), u = t === sa ? E : ua(n[0][1], n[1][1])], [l = t === la ? N : aa(n[0][0], n[1][0]), d = t === sa ? k : aa(n[0][1], n[1][1])]], $.length > 1 && I(e)
                } else i = A[0][0], u = A[0][1], l = A[1][0], d = A[1][1];
                a = i, c = u, h = l, p = d;
                var R = Kn(_).attr("pointer-events", "none"), F = R.selectAll(".overlay").attr("cursor", da[b]);
            ...
            function U(t) {
                for (const n of t.changedTouches || [t]) for (const t of $) t.identifier === n.identifier && (t.cur = ee(n, _));
                if (z && !y && !v && 1 === $.length) {
                    const t = $[0];
            ...
            function I(t) {
                ...
                h < a && (x *= -1, r = i, i = l, l = r, r = a, a = h, h = r, b in pa && F.attr("cursor", da[b = pa[b]])), p < c && (w *= -1, r = u, u = d, d = r, r = c, c = p, p = r, b in ga && F.attr("cursor", da[b = ga[b]])), M.selection && (A = M.selection), y && (a = A[0][0], h = A[1][0]), v && (c = A[0][1], p = A[1][1]), A[0][0] === a && A[0][1] === c && A[1][0] === h && A[1][1] === p || (M.selection = [[a, c], [h, p]], f.call(_), D.brush(t, m.name))
            }
            ...
            function O(t) {
                ...
                R.attr("pointer-events", "all"), F.attr("cursor", da.overlay), M.selection && (A = M.selection), function (t) {
        ...
        return c.move = function (n, e, r) {
            n.tween ? n.on("start.brush", (function (t) {
                ...
                var n = this, r = n.__brush, i = s(n, arguments), o = r.selection,
                    a = t.input("function" == typeof e ? e.apply(this, arguments) : e, r.extent), u = Vr(o, a);
    ...
    var Ta = Math.abs, Aa = Math.cos, Sa = Math.sin, Ea = Math.PI, Na = Ea / 2, ka = 2 * Ea, Ca = Math.max, Pa = 1e-12;
    ...
    const Da = Math.PI, Ra = 2 * Da, Fa = 1e-6, qa = Ra - Fa;
    ...
    let Ia = class {
        ...
        arcTo(t, n, e, r, i) {
            ...
            if (null === this._x1) this._append`M${this._x1 = t},${this._y1 = n}`; else if (l > Fa) if (Math.abs(s * u - c * f) > Fa && i) {
                let h = e - o, d = r - a, p = u * u + c * c, g = h * h + d * d, y = Math.sqrt(p), v = Math.sqrt(l),
                    _ = i * Math.tan((Da - Math.acos((p + l - g) / (2 * y * v))) / 2), b = _ / v, m = _ / y;
    ...
    function Za(t) {
        var n = La, e = ja, r = Ha, i = Ha, o = Xa, a = Ga, u = Va, c = null;

        function f() {
            var f, s = n.apply(this, arguments), l = e.apply(this, arguments), h = u.apply(this, arguments) / 2,
                d = Ba.call(arguments), p = +r.apply(this, (d[0] = s, d)), g = o.apply(this, d) - Na,
                y = a.apply(this, d) - Na, v = +i.apply(this, (d[0] = l, d)), _ = o.apply(this, d) - Na,
                b = a.apply(this, d) - Na;
            if (c || (c = f = Oa()), h > Pa && (Ta(y - g) > 2 * h + Pa ? y > g ? (g += h, y -= h) : (g -= h, y += h) : g = y = (g + y) / 2, Ta(b - _) > 2 * h + Pa ? b > _ ? (_ += h, b -= h) : (_ -= h, b += h) : _ = b = (_ + b) / 2), c.moveTo(p * Aa(g), p * Sa(g)), c.arc(0, 0, p, g, y), g !== _ || y !== b) if (t) {
    ...
    function tu(t, n) {
        for (var e, r = -1, i = n.length; ++r < i;) if (e = nu(t, n[r])) return e;
        return 0
    }
    ...
    function ou() {
        ...
        function i(t) {
            var n = e(t);
            if (Array.isArray(n)) n = n.slice().sort(Qa); else {
                const e = T(t, au);
        ...
        function o(e, i) {
            ...
            return function (e, r, i) {
                ...
                for (var n, e = 0, r = u.length; e < r; ++e) if (-1 !== tu((n = u[e])[0], t)) return void n.push(t)
        ...
        function u(e, r, i) {
            e.forEach((function (e) {
                var o = e[0], a = e[1], u = 0 | o, c = 0 | a, f = cu(r[c * t + u]);
    ...
    const du = 134217729, pu = 33306690738754706e-32;
    ...
    const vu = 22204460492503146e-32, _u = 11093356479670487e-47, bu = yu(4), mu = yu(8), xu = yu(12), wu = yu(16),
        Mu = yu(4);
    ...
    const Au = Math.pow(2, -52), Su = new Uint32Array(512);
    ...
    class Eu {
        ...
        update() {
            ...
            for (let o, a, u = 0; u < this._ids.length; u++) {
                ...
                l = n[l];
                let g, y = l;
                for (; g = e[y], Tu(f, s, t[2 * y], t[2 * y + 1], t[2 * g], t[2 * g + 1]) >= 0;) if (y = g, y === l) {
                    y = -1;
                    break
                }
                if (-1 === y) continue;
                ...
                if (y === l) for (; g = n[y], Tu(f, s, t[2 * g], t[2 * g + 1], t[2 * y], t[2 * y + 1]) < 0;) v = this._addTriangle(g, c, y, -1, r[y], r[g]), this._legalize(v + 2), r[g] = v, e[y] = y, T--, y = g;
    ...
    class Uu {
        ...
        renderCell(t, n) {
            const e = null == n ? n = new Fu : void 0, r = this._clip(t);
    ...
    const Iu = 2 * Math.PI, Ou = Math.pow;
    ...
    class ju {
        ...
        * neighbors(t) {
        ...
        _step(t, n, e) {
            ...
            let f = t, s = Ou(n - c[2 * t], 2) + Ou(e - c[2 * t + 1], 2);
            const l = r[t];
            let h = l;
            do {
                let r = u[h];
        ...
        render(t) {
            const n = null == t ? t = new Fu : void 0, {points: e, halfedges: r, triangles: i} = this;
        ...
        renderPoints(t, n) {
            ...
            const e = null == t ? t = new Fu : void 0, {points: r} = this;
        ...
        renderHull(t) {
            const n = null == t ? t = new Fu : void 0, {hull: e, points: r} = this, i = 2 * e[0], o = e.length;
            t.moveTo(r[i], r[i + 1]);
            for (let n = 1; n < o; ++n) {
                const i = 2 * e[n];
                t.lineTo(r[i], r[i + 1])
        ...
        renderTriangle(t, n) {
            const e = null == n ? n = new Fu : void 0, {points: r, triangles: i} = this, o = 2 * i[t *= 3],
                a = 2 * i[t + 1], u = 2 * i[t + 2];
    ...
    function tc(t) {
        ...
        function r(t, n) {
            ...
            function s() {
                ...
                for (; a < o;) {
                    if ((r = t.charCodeAt(n = a++)) === Vu) f = !0; else if (r === Wu) f = !0, t.charCodeAt(a) === Vu && ++a; else if (r !== e) continue;
                    return t.slice(i, n)
                }
                return c = !0, t.slice(i, o)
            }

            for (t.charCodeAt(o - 1) === Vu && --o, t.charCodeAt(o - 1) === Wu && --o; (r = s()) !== Xu;) {
    ...
    var nc = tc(","), ec = nc.parse, rc = nc.parseRows, ic = nc.format, oc = nc.formatBody, ac = nc.formatRows,
        uc = nc.formatRow, cc = nc.formatValue, fc = tc("\t"), sc = fc.parse, lc = fc.parseRows, hc = fc.format,
        dc = fc.formatBody, pc = fc.formatRows, gc = fc.formatRow, yc = fc.formatValue;
    ...
    var Ec = Sc("application/xml"), Nc = Sc("text/html"), kc = Sc("image/svg+xml");
    ...
    qc.copy = function () {
        ...
        for (g && p.push(new Pc(g, s, l, h, d)), null == e ? e = 1 / 0 : (s = t - e, l = n - e, h = t + e, d = n + e, e *= e); c = p.pop();) if (!(!(g = c.node) || (i = c.x0) > h || (o = c.y0) > d || (a = c.x1) < s || (u = c.y1) < l)) if (g.length) {
            var y = (i + a) / 2, v = (o + u) / 2;
        ...
        for (c && u.push(new Pc(c, this._x0, this._y0, this._x1, this._y1)); n = u.pop();) if (!t(c = n.node, r = n.x0, i = n.y0, o = n.x1, a = n.y1) && c.length) {
            var f = (r + o) / 2, s = (i + a) / 2;
    ...
    const jc = 1664525, Hc = 1013904223, Xc = 4294967296;
    ...
    function ff(t) {
        var n, e,
            r = void 0 === t.grouping || void 0 === t.thousands ? of : (n = uf.call(t.grouping, Number), e = t.thousands + "", function (t, r) {
            ...
            }(uf.call(t.numerals, String)), c = void 0 === t.percent ? "%" : t.percent + "",
            f = void 0 === t.minus ? "−" : t.minus + "", s = void 0 === t.nan ? "NaN" : t.nan + "";

        function l(t) {
            var n = (t = tf(t)).fill, e = t.align, l = t.sign, h = t.symbol, d = t.zero, p = t.width, g = t.comma,
            ...
            var b = "$" === h ? i : "#" === h && /[boxX]/.test(_) ? "0" + _.toLowerCase() : "",
                m = "$" === h ? o : /[%p]/.test(_) ? c : "", x = rf[_], w = /[defgprs%]/.test(_);
            ...
            function M(t) {
                ...
                if ("c" === _) M = x(t) + M, t = ""; else {
                    ...
                    }(t)), T && 0 == +t && "+" !== l && (T = !1), h = (T ? "(" === l ? l : f : "-" === l || "(" === l ? "" : l) + h, M = ("s" === _ ? cf[8 + Qc / 3] : "") + M + (T && "(" === l ? ")" : ""), w) for (i = -1, o = t.length; ++i < o;) if (48 > (c = t.charCodeAt(i)) || c > 57) {
        ...
        return {
            format: l, formatPrefix: function (t, n) {
                var e = l(((t = tf(t)).type = "f", t)), r = 3 * Math.max(-8, Math.min(8, Math.floor(Kc(n) / 3))),
                    i = Math.pow(10, -r), o = cf[8 + r / 3];
                return function (t) {
                    return e(i * t) + o
                }
            }
    ...
    t.format = void 0, t.formatPrefix = void 0, sf({thousands: ",", grouping: [3], currency: ["$", ""]});
    var pf = 1e-6, gf = 1e-12, yf = Math.PI, vf = yf / 2, _f = yf / 4, bf = 2 * yf, mf = 180 / yf, xf = yf / 180,
        wf = Math.abs, Mf = Math.atan, Tf = Math.atan2, Af = Math.cos, Sf = Math.ceil, Ef = Math.exp, Nf = Math.hypot,
        kf = Math.log, Cf = Math.pow, Pf = Math.sin, zf = Math.sign || function (t) {
            return t > 0 ? 1 : t < 0 ? -1 : 0
        }, $f = Math.sqrt, Df = Math.tan;
    ...
    var Hf, Xf, Gf, Vf, Wf, Zf, Kf, Qf, Jf, ts, ns, es, rs, is, os, as, us = new A, cs = new A, fs = {
        point: Uf, lineStart: Uf, lineEnd: Uf, polygonStart: function () {
    ...
    function ds(t, n) {
        var e = (t *= xf) - Gf, r = e >= 0 ? 1 : -1, i = r * e, o = Af(n = (n *= xf) / 2 + _f), a = Pf(n), u = Wf * a,
            c = Vf * o + u * Af(i), f = u * r * Pf(i);
    ...
    var xs, ws, Ms, Ts, As, Ss, Es, Ns, ks, Cs, Ps, zs, $s, Ds, Rs, Fs, qs = {
        point: Us, lineStart: Os, lineEnd: Bs, polygonStart: function () {
    ...
    function Is(t, n) {
        var e = gs([t * xf, n * xf]);
        if (rs) {
            var r = vs(rs, e), i = vs([r[1], -r[0], 0], r);
            ms(i), i = ps(i);
    ...
    var Vs = {
        sphere: Uf, point: Ws, lineStart: Ks, lineEnd: tl, polygonStart: function () {
    ...
    function Js(t, n) {
        t *= xf;
        var e = Af(n *= xf), r = e * Af(t), i = e * Pf(t), o = Pf(n),
    ...
    function il(t, n) {
        t *= xf;
        var e = Af(n *= xf), r = e * Af(t), i = e * Pf(t), o = Pf(n), a = Rs * o - Fs * i, u = Fs * r - Ds * o,
            c = Ds * i - Rs * r, f = Nf(a, u, c), s = Ff(f), l = f && -s / f;
    ...
    function ll(t, n) {
        var e = Af(t), r = Pf(t), i = Af(n), o = Pf(n);

        function a(t, n) {
            var a = Af(n), u = Af(t) * a, c = Pf(t) * a, f = Pf(n), s = f * e + u * r;
            return [Tf(c * i - s * o, u * e - f * r), Ff(s * i + c * o)]
        }

        return a.invert = function (t, n) {
            var a = Af(n), u = Af(t) * a, c = Pf(t) * a, f = Pf(n), s = f * i - c * o;
    ...
    function xl(t, n) {
        var e = ml(n), r = n[1], i = Pf(r), o = [Pf(e), -Af(e), 0], a = 0, u = 0, c = new A;
        1 === i ? r = vf + pf : -1 === i && (r = -vf - pf);
        for (var f = 0, s = t.length; f < s; ++f) if (h = (l = t[f]).length) for (var l, h, d = l[h - 1], p = ml(d), g = d[1] / 2 + _f, y = Pf(g), v = Af(g), _ = 0; _ < h; ++_, p = m, y = w, v = M, d = b) {
            var b = l[_], m = ml(b), x = b[1] / 2 + _f, w = Pf(x), M = Af(x), T = m - p, S = T >= 0 ? 1 : -1, E = S * T,
                N = E > yf, k = y * w;
    ...
    var Al = wl((function () {
        ...
        var i;
        if (null == t) i = e * vf, r.point(-yf, i), r.point(0, i), r.point(yf, i), r.point(yf, 0), r.point(yf, -i), r.point(0, -i), r.point(-yf, -i), r.point(-yf, 0), r.point(-yf, i); else if (wf(t[0] - n[0]) > pf) {
            var o = t[0] < n[0] ? yf : -yf;
    ...
    function Sl(t) {
        var n = Af(t), e = 6 * xf, r = n > 0, i = wf(n) > pf;
        ...
        function a(t, e, r) {
            var i = [1, 0, 0], o = vs(gs(t), gs(e)), a = ys(o, o), u = o[0], c = a - u * u;
            if (!c) return !r && t;
            var f = n * a / c, s = -n * u / c, l = vs(i, o), h = bs(i, f);
            _s(h, bs(o, s));
            var d = l, p = ys(h, d), g = ys(d, d), y = p * p - g * (ys(h, h) - 1);
            if (!(y < 0)) {
                var v = $f(y), _ = bs(d, (-p - v) / g);
                if (_s(_, h), _ = ps(_), !r) return _;
                var b, m = t[0], x = e[0], w = t[1], M = e[1];
                x < m && (b = m, m = x, x = b);
                var T = x - m, A = wf(T - yf) < pf;
        ...
        return wl(o, (function (t) {
            ...
            return {
                lineStart: function () {
                    ...
                    if (!n && (f = c = g) && t.lineStart(), g !== c && (!(d = a(n, p)) || yl(n, d) || yl(p, d)) && (p[2] = 1), g !== c) s = 0, g ? (t.lineStart(), d = a(p, n), t.point(d[0], d[1])) : (d = a(n, p), t.point(d[0], d[1], 2), t.lineEnd()), n = d; else if (i && n && r ^ g) {
                        var v;
    ...
    var Dl = {
        sphere: Uf, point: Uf, lineStart: function () {
            Dl.point = Fl, Dl.lineEnd = Rl
        }, lineEnd: Uf, polygonStart: Uf, polygonEnd: Uf
    };
    ...
    function ql(t, n) {
        t *= xf;
        var e = Pf(n *= xf), r = Af(n), i = wf(t - Nl), o = Af(i), a = r * Pf(i), u = Cl * e - kl * r * o,
            c = kl * e + Cl * r * o;
    ...
    var Il = [null, null], Ol = {type: "LineString", coordinates: Il};
    ...
    var Yl = {
        Feature: function (t, n) {
            ...
            for (var e = t.features, r = -1, i = e.length; ++r < i;) if (jl(e[r].geometry, n)) return !0;
            return !1
        }
    }, Ll = {
        Sphere: function () {
            ...
            for (var e = t.coordinates, r = -1, i = e.length; ++r < i;) if (Gl(e[r], n)) return !0;
            return !1
        }, GeometryCollection: function (t, n) {
            for (var e = t.geometries, r = -1, i = e.length; ++r < i;) if (jl(e[r], n)) return !0;
            return !1
        }
    };
    ...
    var lh = ah, hh = 1 / 0, dh = hh, ph = -hh, gh = ph, yh = {
        point: function (t, n) {
            t < hh && (hh = t);
            t > ph && (ph = t);
            n < dh && (dh = n);
            n > gh && (gh = n)
        }, lineStart: Uf, lineEnd: Uf, polygonStart: Uf, polygonEnd: Uf, result: function () {
            var t = [[hh, dh], [ph, gh]];
            return ph = gh = -(dh = hh = 1 / 0), t
        }
    };
    var vh, _h, bh, mh, xh = yh, wh = 0, Mh = 0, Th = 0, Ah = 0, Sh = 0, Eh = 0, Nh = 0, kh = 0, Ch = 0, Ph = {
        point: zh, lineStart: $h, lineEnd: Fh, polygonStart: function () {
    ...
    ad.prototype = {
        constructor: ad, point: function (t, n) {
    ...
    function pd(t, n) {
        return +n ? function (t, n) {
            function e(r, i, o, a, u, c, f, s, l, h, d, p, g, y) {
                ...
                if (b > 4 * n && g--) {
                    var m = a + h, x = u + d, w = c + p, M = $f(m * m + x * x + w * w), T = Ff(w /= M),
                        A = wf(wf(w) - 1) < pf || wf(o - l) < pf ? (o + l) / 2 : Tf(x, m), S = t(A, T), E = S[0],
    ...
    function yd(t, n, e, r, i, o) {
        ...
        var a = Af(o), u = Pf(o), c = a * t, f = u * t, s = a / t, l = u / t, h = (u * e - a * n) / t,
            d = (u * n + a * e) / t;
    ...
    function _d(t) {
        var n, e, r, i, o, a, u, c, f, s, l = 150, h = 480, d = 250, p = 0, g = 0, y = 0, v = 0, _ = 0, b = 0, m = 1,
            x = 1, w = null, M = Al, T = null, A = rh, S = .5;
        ...
        function k() {
            var t = yd(l, 0, 0, m, x, b).apply(null, n(p, g)), r = yd(l, h - t[0], d - t[1], m, x, b);
        ...
        return E.stream = function (t) {
            ...
            return arguments.length ? (A = null == t ? (T = r = i = o = null, rh) : $l(T = +t[0][0], r = +t[0][1], i = +t[1][0], o = +t[1][1]), C()) : null == T ? null : [[T, r], [i, o]]
        }, E.scale = function (t) {
    ...
    function Td(t) {
        return function (n, e) {
            var r = $f(n * n + e * e), i = t(r), o = Pf(i), a = Af(i);
    ...
    function Nd(t) {
        ...
        function s() {
            var o = yf * a(), u = i(hl(i.rotate()).invert([0, 0]));
    ...
    function Cd(t, n) {
        var e = Af(t), r = t === n ? Pf(t) : kf(e / Af(n)) / kf(kd(n) / kd(t)), i = e * Cf(kd(t), r) / r;
        if (!r) return Ed;
        ...
        return o.invert = function (t, n) {
            var e = i - n, o = zf(r) * $f(t * t + e * e), a = Tf(t, wf(e)) * zf(e);
    ...
    function zd(t, n) {
        var e = Af(t), r = t === n ? Pf(t) : (e - Af(n)) / (n - t), i = e / r + t;
    ...
    var $d = 1.340264, Dd = -.081106, Rd = 893e-6, Fd = .003796, qd = $f(3) / 2;

    function Ud(t, n) {
        var e = Ff(qd * Pf(n)), r = e * e, i = r * r * r;
    ...
    function Vd(t, n) {
        ...
        for (var e, r, i, o, a, u = new Jd(t), c = [u]; e = c.pop();) if ((i = n(e.data)) && (a = (i = Array.from(i)).length)) for (e.children = i, o = a - 1; o >= 0; --o) c.push(r = i[o] = new Jd(i[o])), r.parent = e, r.depth = e.depth + 1;
    ...
    const ip = 1664525, op = 1013904223, ap = 4294967296;
    ...
    function fp(t, n) {
        var e, r;
        if (hp(n, t)) return [n];
        for (e = 0; e < t.length; ++e) if (sp(n, t[e]) && hp(pp(t[e], n), t)) return [t[e], n];
        for (e = 0; e < t.length - 1; ++e) for (r = e + 1; r < t.length; ++r) if (sp(pp(t[e], t[r]), n) && sp(pp(t[e], n), t[r]) && sp(pp(t[r], n), t[e]) && hp(gp(t[e], t[r], n), t)) return [t[e], t[r], n];
        throw new Error
    }
    ...
    function mp(t, n) {
        ...
        t:for (c = 3; c < o; ++c) {
            ...
            for (i.previous = e, i.next = r, e.next = r.previous = r = i, a = _p(e); (i = i.next) !== r;) (u = _p(i)) < a && (e = i, a = u);
            r = e.next
        }
    ...
    var Vp = Math.random, Wp = function t(n) {
        function e(t, e) {
        ...
        var e = og.source(n), r = ug.source(n);
    ...
    function Mg(t, n, e) {
        ...
        return i < r ? (r = wg(i, r), o = e(a, o)) : (r = wg(r, i), o = e(o, a)), function (t) {
            return o(r(t))
        }
    }
    ...
    function qg(n) {
        ...
        }, e.nice = () => r(Cg(r(), {floor: t => o(Math.floor(i(t))), ceil: t => o(Math.ceil(i(t)))})), e
    }
    ...
    const Kg = Zg.range, Qg = 1e3, Jg = 6e4, ty = 60 * Jg, ny = 24 * ty, ey = 7 * ny, ry = 30 * ny, iy = 365 * ny,
        oy = Wg((t => {
            t.setTime(t - t.getMilliseconds())
        }), ((t, n) => {
            t.setTime(+t + n * Qg)
        }), ((t, n) => (n - t) / Qg), (t => t.getUTCSeconds())), ay = oy.range, uy = Wg((t => {
            t.setTime(t - t.getMilliseconds() - t.getSeconds() * Qg)
        }), ((t, n) => {
            t.setTime(+t + n * Jg)
        }), ((t, n) => (n - t) / Jg), (t => t.getMinutes())), cy = uy.range, fy = Wg((t => {
            t.setUTCSeconds(0, 0)
        }), ((t, n) => {
            t.setTime(+t + n * Jg)
        }), ((t, n) => (n - t) / Jg), (t => t.getUTCMinutes())), sy = fy.range, ly = Wg((t => {
            t.setTime(t - t.getMilliseconds() - t.getSeconds() * Qg - t.getMinutes() * Jg)
        }), ((t, n) => {
            t.setTime(+t + n * ty)
        }), ((t, n) => (n - t) / ty), (t => t.getHours())), hy = ly.range, dy = Wg((t => {
            t.setUTCMinutes(0, 0, 0)
        }), ((t, n) => {
            t.setTime(+t + n * ty)
        }), ((t, n) => (n - t) / ty), (t => t.getUTCHours())), py = dy.range,
        ...
        }), ((t, n) => (n - t) / ny), (t => t.getUTCDate() - 1)), _y = vy.range, by = Wg((t => {
            t.setUTCHours(0, 0, 0, 0)
        }), ((t, n) => {
            t.setUTCDate(t.getUTCDate() + n)
        }), ((t, n) => (n - t) / ny), (t => Math.floor(t / ny))), my = by.range;
    ...
    const wy = xy(0), My = xy(1), Ty = xy(2), Ay = xy(3), Sy = xy(4), Ey = xy(5), Ny = xy(6), ky = wy.range,
        Cy = My.range, Py = Ty.range, zy = Ay.range, $y = Sy.range, Dy = Ey.range, Ry = Ny.range;
    ...
    const qy = Fy(0), Uy = Fy(1), Iy = Fy(2), Oy = Fy(3), By = Fy(4), Yy = Fy(5), Ly = Fy(6), jy = qy.range,
        Hy = Uy.range, Xy = Iy.range, Gy = Oy.range, Vy = By.range, Wy = Yy.range, Zy = Ly.range, Ky = Wg((t => {
    ...
    function dv(t) {
        var n = t.dateTime, e = t.date, r = t.time, i = t.periods, o = t.days, a = t.shortDays, u = t.months,
            c = t.shortMonths, f = xv(i), s = wv(i), l = xv(o), h = wv(o), d = xv(a), p = wv(a), g = xv(u), y = wv(u),
            v = xv(c), _ = wv(c), b = {
                a: function (t) {
                    return a[t.getDay()]
                }, A: function (t) {
                    ...
                    return u[t.getMonth()]
                }, c: null, d: Lv, e: Lv, f: Vv, g: o_, G: u_, H: jv, I: Hv, j: Xv, L: Gv, m: Wv, M: Zv, p: function (t) {
                    return i[+(t.getHours() >= 12)]
                }, q: function (t) {
                    return 1 + ~~(t.getMonth() / 3)
                }, Q: C_, s: P_, S: Kv, u: Qv, U: Jv, V: n_, w: e_, W: r_, x: null, X: null, y: i_, Y: a_, Z: c_, "%": k_
            }, m = {
                a: function (t) {
                ...
                }, c: null, d: f_, e: f_, f: p_, g: A_, G: E_, H: s_, I: l_, j: h_, L: d_, m: g_, M: y_, p: function (t) {
                    return i[+(t.getUTCHours() >= 12)]
                }, q: function (t) {
                    return 1 + ~~(t.getUTCMonth() / 3)
                }, Q: C_, s: P_, S: v_, u: __, U: b_, V: x_, w: w_, W: M_, x: null, X: null, y: T_, Y: S_, Z: N_, "%": k_
            }, x = {
                a: function (t, n, e) {
                    ...
                    return T(t, n, e, r)
                }, d: $v, e: $v, f: Iv, g: kv, G: Nv, H: Rv, I: Rv, j: Dv, L: Uv, m: zv, M: Fv, p: function (t, n, e) {
                    var r = f.exec(n.slice(e));
                    return r ? (t.p = s.get(r[0].toLowerCase()), e + r[0].length) : -1
                }, q: Pv, Q: Bv, s: Yv, S: qv, u: Tv, U: Av, V: Sv, w: Mv, W: Ev, x: function (t, n, r) {
                    return T(t, e, n, r)
                }, X: function (t, n, e) {
                    return T(t, r, n, e)
                }, y: kv, Y: Nv, Z: Cv, "%": Ov
    ...
    var pv, gv = {"-": "", _: " ", 0: "0"}, yv = /^\s*\d+/, vv = /^%/, _v = /[\\^$*+?|[\]().{}]/g;
    ...
    function O_(t, n, e, r, i, o, a, u, c, f) {
        var s = Eg(), l = s.invert, h = s.domain, d = f(".%L"), p = f(":%S"), g = f("%I:%M"), y = f("%I %p"),
    ...
    var G_ = X_("1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf"),
        ...
        eb = X_("4e79a7f28e2ce1575976b7b259a14fedc949af7aa1ff9da79c755fbab0ab"), rb = t => qr(t[t.length - 1]),
        ...
        rm = rb(em);
    var im = di(Ar(300, .5, 0), Ar(-240, .5, 1)), om = di(Ar(-100, .75, .35), Ar(80, 1.5, .8)),
        am = di(Ar(260, .75, .35), Ar(80, 1.5, .8)), um = Ar();
    var cm = qe(), fm = Math.PI / 3, sm = 2 * Math.PI / 3;
    ...
    Tw.prototype = ww.prototype, t.Adder = A, t.Delaunay = ju, t.FormatSpecifier = nf, t.InternMap = InternMap, t.InternSet = InternSet, t.Node = Jd, t.Path = Ia, t.Voronoi = Uu, t.ZoomTransform = ww, t.active = function (t, n) {
        ...
        if (i) for (r in n = null == n ? null : n + "", i) if ((e = i[r]).state > Ui && e.name === n) return new go([[t]], Ko, n, +r);
        return null
    }, t.arc = function () {
        ...
        var t = su, n = lu, e = hu, r = 960, i = 500, o = 20, a = 2, u = 3 * o, c = r + 2 * u >> a, f = i + 2 * u >> a,
            s = Ja(20);
        ...
        return d.contours = function (t) {
            var n = l(t), e = ou().size([c, f]), r = Math.pow(2, 2 * a), i = t => {
                t = +t;
        ...
        function a() {
            for (var t, a, c, f, s, l, h, d = n.length, p = 0; p < o; ++p) for (a = Dc(n, Oc, Bc).visitAfter(u), t = 0; t < d; ++t) c = n[t], l = e[c.index], h = l * l, f = c.x + c.vx, s = c.y + c.vy, a.visit(g);
        ...
        function l(r) {
            for (var i = 0, u = t.length; i < s; ++i) for (var c, f, l, h, d, p, g, y = 0; y < u; ++y) f = (c = t[y]).source, h = (l = c.target).x + l.vx - f.x - f.vx || Ic(a), d = l.y + l.vy - f.y - f.vy || Ic(a), h *= p = ((p = Math.sqrt(h * h + d * d)) - e[y]) / p * r * n[y], d *= p, l.vx -= h * (g = o[y]), l.vy -= d * g, f.vx += h * (g = 1 - g), f.vy += d * g
        }
        ...
        var n, e = 1, r = .001, i = 1 - Math.pow(r, 1 / 300), o = 0, a = .6, u = new Map, c = ki(l),
            f = Dt("tick", "end"), s = function () {
                let t = 1;
        ...
        var t, n, e, r, i, o, a = wd(), u = xd().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
            c = xd().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]), f = {
                point: function (t, n) {
                    o = [t, n]
                }
            };
        ...
        return s.invert = function (t) {
            ...
            return e = a.translate(t).clipExtent([[o - .455 * n, s - .238 * n], [o + .455 * n, s + .238 * n]]).stream(f), r = u.translate([o - .307 * n, s + .201 * n]).clipExtent([[o - .425 * n + pf, s + .12 * n + pf], [o - .214 * n - pf, s + .234 * n - pf]]).stream(f), i = c.translate([o - .205 * n, s + .212 * n]).clipExtent([[o - .214 * n + pf, s + .166 * n + pf], [o - .115 * n - pf, s + .234 * n - pf]]).stream(f), l()
        ...
        return os = as = null, Zf === 1 / 0 || Kf === 1 / 0 ? [[NaN, NaN], [NaN, NaN]] : [[Zf, Kf], [Qf, Jf]]
    },t.geoCentroid = function (t) {
        xs = ws = Ms = Ts = As = Ss = Es = Ns = 0, ks = new A, Cs = new A, Ps = new A, jf(t, Vs);
        var n = +ks, e = +Cs, r = +Ps, i = Nf(n, e, r);
        ...
        function a() {
            var a = e.apply(this, arguments), u = r.apply(this, arguments) * xf, c = i.apply(this, arguments) * xf;
        ...
        return b.invert = function (e) {
            ...
            return arguments.length ? (v = null == t ? (d = e = r = i = null, rh) : $l(d = +t[0][0], e = +t[0][1], r = +t[1][0], i = +t[1][1]), _()) : null == d ? null : [[d, e], [r, i]]
        }, b.scale = function (t) {
        ...
        var e = t[0] * xf, r = t[1] * xf, i = n[0] * xf, o = n[1] * xf, a = Af(r), u = Pf(r), c = Af(o), f = Pf(o),
            s = a * Af(e), l = a * Pf(e), h = c * Af(i), d = c * Pf(i), p = 2 * Ff($f(qf(o - r) + a * c * qf(i - e))),
            g = Pf(p), y = p ? function (t) {
                var n = Pf(t *= p) / g, e = Pf(p - t) / g, r = e * s + n * h, i = e * l + n * d, o = e * u + n * f;
        ...
        var t = Nd(Ld), n = t.center, e = t.rotate;
        ...
        var e = Dr((t = ur(t)).l, (n = ur(n)).l), r = Dr(t.a, n.a), i = Dr(t.b, n.b), o = Dr(t.opacity, n.opacity);
        return function (n) {
        ...
        var o = Gp(r), a = Gp(i), u = a[0] === o[0], c = a[a.length - 1] === o[o.length - 1], f = [];
        ...
        function r(r) {
            ...
            if (null != t) {
                const n = h.map(((n, e) => function (t) {
                    ...
                    return "/" === t[0] ? t : `/${t}`
                }(t(n, e, r)))), e = n.map(zp), i = new Set(n).add("");
        ...
        var t = Dp, n = 1, e = 1, r = null;

        function i(i) {
            var c = function (t) {
                for (var n, e, r, i, o, a = new Ip(t, 0), u = [a]; n = u.pop();) if (r = n._.children) for (n.children = new Array(o = r.length), i = o - 1; i >= 0; --i) u.push(e = n.children[i] = new Ip(r[i], i)), e.parent = n;
        ...
        var t = Lp, n = !1, e = 1, r = 1, i = [0], o = ep, a = ep, u = ep, c = ep, f = ep;
        ...
        var t, n, e, r = Ew, i = Nw, o = zw, a = Cw, u = Pw, c = [0, 1 / 0], f = [[-1 / 0, -1 / 0], [1 / 0, 1 / 0]],
            s = 250, l = ii, h = Dt("start", "zoom", "end"), d = 500, p = 150, g = 0, y = 10;
        ...
        function T(t, ...n) {
            if (r.apply(this, arguments)) {
                var e = w(this, n).event(t), i = this.__zoom,
                    u = Math.max(c[0], Math.min(c[1], i.k * Math.pow(2, a.apply(this, arguments)))), s = ee(t);
        ...
        function A(t, ...n) {
            if (!e && r.apply(this, arguments)) {
                var i = t.currentTarget, a = w(this, n, !0).event(t),
                    ...
                    }), !0), c = ee(t, i), s = t.clientX, l = t.clientY;
        ...
        function S(t, ...n) {
            if (r.apply(this, arguments)) {
                var e = this.__zoom, a = ee(t.changedTouches ? t.changedTouches[0] : t, this), u = e.invert(a),
        ...
        function k(t, ...r) {
            if (this.__zooming) {
                ...
                if (a.touch1 && !a.touch0 && (a.touch0 = a.touch1, delete a.touch1), a.touch0) a.touch0[1] = this.__zoom.invert(a.touch0[0]); else if (a.end(), 2 === a.taps && (o = ee(o, this), Math.hypot(n[0] - o[0], n[1] - o[1]) < y)) {
